...
class DepthImageSaver(Node):
    ...
    def _get_start_index(self) -> int:
        pattern = re.compile(r"franka_depth_(\d+)\.npy") #for heal use 'heal_depth_(\d+)\.npy' , for franka use 'franka_depth_(\d+)\.npy'
        max_index = -1
    ...
    def depth_callback(self, msg: Image):
        ...
        try:
            ...
            filename = f"franka_depth_{self.image_index}.npy"
